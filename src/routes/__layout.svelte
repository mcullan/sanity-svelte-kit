...
<div bind:clientWidth={wrapperWidth} class="relative min-h-[100vh]">
...
{#if wrapperWidth < 640}
	<div class="dark:bg-p3-7  bg-p3-1 transition-colors duration-500 fixed bottom-0 w-full h-[60px]">
		<NavMobile />
	</div>
{/if}
