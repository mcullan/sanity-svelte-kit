<ul class="flex w-full text-p3-5  flex-col justify-between pt-2 pb-[16px] ">
	<li>
		<div class="flex gap-2 text-p3-5 hover:text-p3-3 dark:text-p3-4 dark:hover:text-p3-3">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="-2 -4 24 24" width="24" fill="currentColor"><path d="M20 1.907a8.292 8.292 0 0 1-2.356.637A4.07 4.07 0 0 0 19.448.31a8.349 8.349 0 0 1-2.607.98A4.12 4.12 0 0 0 13.846.015c-2.266 0-4.103 1.81-4.103 4.04 0 .316.036.625.106.92A11.708 11.708 0 0 1 1.393.754a3.964 3.964 0 0 0-.554 2.03c0 1.403.724 2.64 1.824 3.363A4.151 4.151 0 0 1 .805 5.64v.05c0 1.958 1.415 3.591 3.29 3.963a4.216 4.216 0 0 1-1.08.141c-.265 0-.522-.025-.773-.075a4.098 4.098 0 0 0 3.832 2.807 8.312 8.312 0 0 1-5.095 1.727c-.332 0-.658-.02-.979-.056a11.727 11.727 0 0 0 6.289 1.818c7.547 0 11.673-6.157 11.673-11.496l-.014-.523A8.126 8.126 0 0 0 20 1.907z" /></svg>
			<a rel="noreferrer noopener" target="_blank" href="https://twitter.com/michaelcullan">
				Twitter: @michaelcullan
			</a>
		</div>
	</li>
	<li>
		<div class="flex gap-2 text-p3-5 hover:text-p3-3 dark:text-p3-4 dark:hover:text-p3-3">
			...
			>
			<a rel="noreferrer noopener" href="https://github.com/mcullan">Github: mcullan</a>
		</div>
	</li>
	<li>
		<div class="flex gap-2 text-p3-5 hover:text-p3-3 dark:text-p3-4 dark:hover:text-p3-3">
            ...
            <a href="https://linkedin.com/in/mcullan" rel="noreferrer noopener" target="_blank">LinkedIn</a>
        </div>
        </li>
		<div class="flex gap-2 text-p3-5 hover:text-p3-3 dark:text-p3-4 dark:hover:text-p3-3">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="-2 -5 24 24" width="24" fill="currentColor"><path d="M18.572.083L10.676 7.12a1 1 0 0 1-1.331 0L1.416.087A2 2 0 0 1 2 0h16a2 2 0 0 1 .572.083zm1.356 1.385c.047.17.072.348.072.532v10a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2c0-.185.025-.364.072-.534l7.942 7.148a3 3 0 0 0 3.992 0l7.922-7.146z"></path></svg>
            <li><a rel="noreferrer noopener" href="https://mailto:mjcullan@gmail.com">Email</a></li>
        </div>
</ul>
